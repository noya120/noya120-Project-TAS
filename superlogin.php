...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows === 1) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            $_SESSION['super_id'] = $user['super_id']; // Simpan ID superadmin
    ...
    } else { // jika user tidak ditemukan akan memunculkan pesan user tidak ditemukan
        echo "<p style='color: red; text-align: center;'>User tidak ditemukan.</p>";
    }
    $stmt->close();
}
$conn->close();
...
<div class="login">
    ...
    <hr>
        ...
        <hr>
        <a href="superlogin.php">Login Sebagai SuperAdmin</a>
        <a href="adminlogin.php">Login Sebagai Admin</a>
        <a href="userlogin.php">Login Sebagai User</a>
    </form>
</div>
</body>
</html>