...
// Periksa apakah sesi superadmin aktif
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $nama = $_POST['nama'];
    $super_id = $_SESSION['super_id']; // Foreign key
    ...
    $query = "INSERT INTO admin (username, password, nama, foto, super_id) 
              VALUES (?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("sssss", $username, $password, $nama, $fotoData, $super_id);
