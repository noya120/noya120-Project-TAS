...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="nav-item">
            ...
            <a href="formbuku.php"><span>Tambah Buku</span></a>
        </div>
        <div class="nav-item">
            <i class="fas fa-book"></i>
            <a href="updatebuku.php"><span>Edit Buku</span></a>
        </div>
        <div class="nav-item">
            <i class="fas fa-book"></i>
            <a href="databukuA.php"><span>Data Buku</span></a>
        </div>
        <div class="nav-item">
            <i class="fas fa-users"></i>
            <a href="dataanggota.php"><span>Data Anggota</span></a>
        </div>
        <div class="nav-item">
            <i class="fas fa-users"></i>
            <a href="updateanggota.php"><span>Edit Anggota</span></a>
        </div>
        ...
        <div class="table-responsive">
            <table class="peminjaman-table">
                ...
                <tbody>
                    <?php
                    $query_anggota = "
                        SELECT user_id, username, nama, alamat, waktupembuatan
                        FROM user 
                        ORDER BY waktupembuatan DESC
                    ";
                    ...
                    <tr>
                        ...
                        <td><?php echo date('d/m/Y', strtotime($row['waktupembuatan'])); ?></td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
