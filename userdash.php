...
if (isset($_POST['kembalikan'])) {
    $peminjaman_id = intval($_POST['peminjaman_id']); // Ambil ID peminjaman dari form
    $conn->query("UPDATE peminjaman SET status='dikembalikan' WHERE id=$peminjaman_id");
    header("Location: userdash.php"); // Reload halaman untuk memperbarui status
    exit();
}
...
$recent_activities = $conn->query("
    SELECT b.judulbuku, p.tanggal_pinjam, p.tanggal_kembali, p.status
    FROM peminjaman p 
...
<body>
    ...
    <div class="nav-item">
        ...
        <div class="nav-item">
            ...
            <a href="userdash.php"><span>Dashboard</span></a>
        </div>
        <div class="nav-item">
            <i class="fas fa-book"></i>
            <a href="databuku.php"><span>Pinjam Buku</span></a>
        </div>
        <div class="nav-item">
            <i class="fas fa-book"></i>
            <a href="pengembalian.php"><span>Pengembalian Buku</span></a>
        </div>
    ...
    <div class="data-recent-activities">
