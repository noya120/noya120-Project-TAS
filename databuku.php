...
if (!isset($_SESSION['user_id'])) {
    header("Location: userlogin.php"); // Pastikan pengguna login
    exit;
}
...
<body>
    ...
    <div class="container mt-5" style="text-align: center;">
        ...
        <div class="d-flex flex-wrap overflow-auto" style="gap: 20px; padding-bottom: 20px;">
            <?php if ($result && $result->num_rows > 0): ?>
                <?php while ($buku = $result->fetch_assoc()): ?>
                    <div class="card" style="width: 18rem;">
                        <!-- Menampilkan Gambar dari BLOB -->
                        <img src="data:image/png;base64,<?= base64_encode($buku['fotobuku']); ?>" 
                            class="card-img-top" alt="<?= htmlspecialchars($buku['judulbuku']); ?>" style="height: 250px; object-fit: cover;">
                        <div class="card-body">
                            <h5 class="card-title"><?= htmlspecialchars($buku['judulbuku']); ?></h5>
                            <p class="card-text"><?= htmlspecialchars($buku['penulis']); ?> (<?= htmlspecialchars($buku['tahunterbit']); ?>)</p>
